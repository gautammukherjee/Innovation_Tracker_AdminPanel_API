...
Route::post('/saveUnacuratedDrug/{id}', [NewsletterController::class, 'saveUnacuratedDrug']);
//3. Save Unacurated Gene data in gene table
Route::post('/saveUnacuratedGene/{id}', [NewsletterController::class, 'saveUnacuratedGene']);
//4. Save Unacurated Org data in company table
Route::post('/saveUnacuratedOrg/{id}', [NewsletterController::class, 'saveUnacuratedOrg']);

//5. Save Curated all Entity data in News Relation table
Route::post('/saveAllEntityNewsRelation/{id}', [NewsletterController::class, 'saveAllEntityNewsRelation']);